...
function Login() {
    return(
        <div className="flex justify-center items-start h-screen  bg-[url('./assets/fondoLogin.png')] bg-cover bg-center bg-no-repeat">
            <article className='w-[90%] py-10 mt-15 flex flex-col justify-center items-center text-white rounded-[20px] bg-black/60 '>
                ...
                <section className='w-[85%] lg:w-[400px]'>   
                    <form action="">
                        ...
                        <Link to="/principal" className="block w-[90%] bg-[#87520E] text-white text-center text py-3 mx-auto mt-7 rounded-[25px] backdrop-blur-md font-bold hover:cursor-pointer hover:bg-[#655e57]/70 transition-all duration-300">
                            Iniciar Sesión
                        </Link> 
